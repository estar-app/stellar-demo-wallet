...
export const checkDepositWithdrawInfo = async ({ type, transferServerUrl, assetCode, }) => {
    log.instruction({
        title: `Checking \`/info\` endpoint to ensure this currency is enabled for ${type === AnchorActionType.DEPOSIT ? "deposit" : "withdrawal"}`,
    });
...
//# sourceMappingURL=checkDepositWithdrawInfo.js.map