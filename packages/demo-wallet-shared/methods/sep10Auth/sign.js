...
export const sign = async ({ challengeTransaction, networkPassphrase, secretKey, walletBackendEndpoint, }) => {
    log.instruction({
        title: "We’ve received a challenge transaction from the server that we need the sending anchor to sign with their Stellar private key",
    });
