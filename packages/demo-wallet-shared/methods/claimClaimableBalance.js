import StellarSdk, { Account, Keypair, Operation, TransactionBuilder, } from "stellar-sdk";
import { getErrorMessage } from "../helpers/getErrorMessage";
import { log } from "../helpers/log";
export const claimClaimableBalance = async ({ secretKey, balance, assetCode, networkPassphrase, networkUrl, fee, }) => {
    log.instruction({
    ...
    try {
        ...
        const accountRecord = await server
            ...
            .call();
        log.instruction({
            title: "Loading account to get a sequence number for `claimClaimableBalance` transaction",
        });
...
//# sourceMappingURL=claimClaimableBalance.js.map