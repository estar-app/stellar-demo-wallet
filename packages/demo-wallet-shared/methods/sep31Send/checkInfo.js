...
export const checkInfo = async ({ assetCode, sendServer, }) => {
    var _a, _b;
    log.instruction({
    ...
    if (asset.sep12) {
        if ((_a = asset.sep12.sender) === null || _a === void 0 ? void 0 : _a.types) {
        ...
        if ((_b = asset.sep12.receiver) === null || _b === void 0 ? void 0 : _b.types) {
...
//# sourceMappingURL=checkInfo.js.map