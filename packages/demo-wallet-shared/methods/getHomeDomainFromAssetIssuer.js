...
export const getHomeDomainFromAssetIssuer = async ({ assetIssuer, networkUrl, }) => {
    log.request({
    ...
    if (!homeDomain) {
        throw new Error(`Asset issuer ${assetIssuer} does not have home domain configured`);
    }
    log.response({
...
//# sourceMappingURL=getHomeDomainFromAssetIssuer.js.map