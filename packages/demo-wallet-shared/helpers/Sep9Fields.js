export var Sep9FieldType;
(function (Sep9FieldType) {
    Sep9FieldType["STRING"] = "string";
    Sep9FieldType["COUNTRY_CODE"] = "country_code";
    Sep9FieldType["PHONE_NUMBER"] = "phone number";
    Sep9FieldType["DATE"] = "date";
    Sep9FieldType["NUMBER"] = "number";
    Sep9FieldType["BINARY"] = "binary";
    Sep9FieldType["LANGUAGE_CODE"] = "language_code";
})(Sep9FieldType || (Sep9FieldType = {}));
export const Sep9Fields = [
    ...
    },
    {
        ...
        type: Sep9FieldType.BINARY,
        description: "Image of a utility bill, bank statement or similar with the user's name and address",
    },
];
export const Sep9FieldsDict = Sep9Fields.reduce((result, sep9Field) => ({
    ...result,
    [sep9Field.name]: sep9Field,
}), {});
//# sourceMappingURL=Sep9Fields.js.map