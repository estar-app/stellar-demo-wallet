...
export const Json = ({ src, collapseStringsAfterLength = 15, displayDataTypes = true, collapsed = false, theme = defaultTheme, }) => (React.createElement(ReactJson, { src: src, collapseStringsAfterLength: collapseStringsAfterLength, displayDataTypes: displayDataTypes, collapsed: collapsed, theme: theme }));
