...
export const Sep8Send = () => {
    ...
    return (React.createElement(React.Fragment, null,
        [Sep8Step.STARTING, Sep8Step.PENDING].includes(sep8Step) && (React.createElement(Sep8Approval, { onClose: onClose })),
        [Sep8Step.TRANSACTION_REVISED, Sep8Step.COMPLETE].includes(sep8Step) && (React.createElement(Sep8Review, { onClose: onClose })),
        [
            Sep8Step.ACTION_REQUIRED,
            Sep8Step.SENT_ACTION_REQUIRED_FIELDS,
        ].includes(sep8Step) && React.createElement(Sep8ActionRequiredForm, { onClose: onClose })));
};
